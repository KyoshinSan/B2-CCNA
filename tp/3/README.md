...
| `client3.lab4.tp3` | X           | X           | X            | X            | X            | X            | X |
| `client4.lab4.tp3` | X           | X           | X            | X            | X            | `10.4.40.101/24` | X |
| `client5.lab4.tp3` | X           | X           | X            | X            | X            | `10.4.40.102/24` | X |
| `server1.lab4.tp3` | X           | X           | X            | X            | `10.4.30.1/24` | X            | X |
| `server2.lab4.tp3` | X           | X           | X            | X            | `10.4.30.2/24` | X            | X |
| `router1.lab4.tp3` | `10.4.1.1/30` | X           | `10.4.1.10/30` | X            | X            | X            | X |
| `router2.lab4.tp3` | `10.4.1.2/30` | `10.4.1.5/30` | X            | X            | X            | `10.4.40.254/24` | X |
| `router3.lab4.tp3` | X           | `10.4.1.6/30` | `10.4.1.9/30` | `10.4.10.254/24` | `10.4.30.254/24` | X            | X |
